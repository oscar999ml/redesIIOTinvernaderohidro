/**
 * ESP8266 Nodo 3 — Control LED + Reporte de estado
 *
 * CONTRATO:
 *   - Se conecta al WiFi AP del ESP32 ("InvernaderoNet")
 *   - Se conecta al TCP server del ESP32 (:3333)
 *   - Recibe comandos: {"nodo_id":3,"accion":"set_led","valor":true/false}
 *   - Reporta estado:  {"nodo_id":3,"tipo":"estado","datos":{"led":true/false,...}}
 *
 * Hardware:
